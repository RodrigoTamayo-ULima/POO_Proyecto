...
public class CandidatosTabla extends javax.swing.JFrame {
    ...
    private CandidatosTabla() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    public CandidatosTabla(registroCandidatos pp) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.pp=pp;
       ...
       datos.addColumn("DNI");
       datos.addColumn("Partido Politico");
       
      
         
         
         for (int i = 0; i < pp.longitud(); i++) {
           candidato cc = pp.iesimo(i);
            String[] fila = new String[3];
            fila[0] = cc.getNombreCompleto();
            fila[1]=cc.getDni();
            fila[2]=cc.getPartidoPolitico();
